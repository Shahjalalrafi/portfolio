      ...
      <div className="container flex">
        ...
        <nav>
          <ul>
            ...
            <a style={{textDecoration: "none"}} href="https://docs.google.com/document/d/1_gPW7vIzUMGcGkLoTkRW_o534uWfcHkhEHjcfO3zpU8/edit?usp=sharing" rel="noreferrer" target="_blank"><li>Resume</li></a>
          </ul>
        </nav>
      </div>
    </div>
